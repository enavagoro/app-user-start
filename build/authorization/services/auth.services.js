...
exports.emailAndPasswordMatch = void 0;
const crypto = __importStar(require("crypto"));
const error_middleware_1 = require("../../shared/middlewares/error.middleware");
const emailAndPasswordMatch = (password, incomingPassword) => {
    ...
    if (encrypthedPassword[1] !== hash) {
        (0, error_middleware_1.generateNewError)(403, 'Connect refused, bad credentials');
    }
};
exports.emailAndPasswordMatch = emailAndPasswordMatch;
